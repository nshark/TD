...
public class Model {
    ...
    public static Model projectile = null;
    private static final HashMap<String, String> name_and_filepath_of_models = new HashMap<>(Map.of(
            ...
            "projectile", "TowerDefense/Models/projectile"));
    ...
    private static void readInModel(String filepath, String name){
        ...
        try {
            ...
            if (Objects.equals(name, "projectile")) {
                projectile = new Model();
                projectile.points = model;
            }
            else{
